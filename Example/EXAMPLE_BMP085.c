...
void EXAMPLE_BMP085(void)
{
	 ...
	 CHAR8U lcd_temp[3]={0},lcd_data[6]={0};
		...
		BMP085_GET_CAL_COEFF();

		/* Get the Temperature & Pressure */
		check_flag_BMP085 = BMP085_GET_TEMP_PRESS(&final_temperature,&final_pressure,OVERSAMPLING);
		
		/* Calculate the altitude */		
		BMP085_GET_ALTITUDE(final_pressure,&final_altitude);

		/* Calculate the sea level pressure */
		BMP085_GET_SEALEVEL_PRESSURE(final_altitude,final_pressure,&final_sealevel_press);
